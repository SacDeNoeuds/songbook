...
export interface SVGAttributes<T extends EventTarget> extends AriaAttributes {
...
export type EventHandlersOf<Tag extends keyof HTMLElementTagNameMap> = Partial<
  Pick<
